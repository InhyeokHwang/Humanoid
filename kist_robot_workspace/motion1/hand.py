...
def play_right(controller, stop_event):
    ...
    CloseHand(controller, hand_sel=1); time.sleep(15.0)
    OpenHand(controller, hand_sel=1); time.sleep(10.0)
...
def play_left(controller, stop_event):
    ...
    if stop_event.is_set(): return
    CloseHand(controller, hand_sel=2); time.sleep(15.0)
    OpenHand(controller, hand_sel=2); time.sleep(10.0)

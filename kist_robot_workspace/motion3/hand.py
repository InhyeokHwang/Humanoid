...
def play_right(controller, stop_event):
    ...
    CloseHand(controller, hand_sel=1); time.sleep(7.0)
    CloseHand(controller, hand_sel=1); time.sleep(6.0)
    Index_Pointing(controller, hand_sel=1); time.sleep(3.0)
    CloseHand(controller, hand_sel=1); time.sleep(4.0)
    OpenHand(controller, hand_sel=1); time.sleep(1.0)
...
def play_left(controller, stop_event):
    ...
    CloseHand(controller, hand_sel=2); time.sleep(7.0)
    CloseHand(controller, hand_sel=2); time.sleep(6.0)
    CloseHand(controller, hand_sel=2); time.sleep(3.0)
    CloseHand(controller, hand_sel=2); time.sleep(4.0)
    OpenHand(controller, hand_sel=2); time.sleep(1.0)
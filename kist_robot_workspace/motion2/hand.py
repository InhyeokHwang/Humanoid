...
def play_right(controller, stop_event):
    ...
    OpenHand(controller, hand_sel=1); time.sleep(8.0)
    CloseHand(controller, hand_sel=1); time.sleep(2.0)  
...
def play_left(controller, stop_event):
    ...
    CloseHand(controller, hand_sel=2); time.sleep(8.0)
    CloseHand(controller, hand_sel=2); time.sleep(2.0)
